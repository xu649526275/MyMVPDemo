...
public class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener implements OnListLoadNextPageListener {
     ...
     * 滑动监听
     */
    private ShowTitleListener mShowTitleListener;
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        if (mShowTitleListener != null) {
            ...
            mShowTitleListener.onScrollY(mScrollHeight);
    ...
    public void setScrollThreshold(int scrollThreshold, ShowTitleListener showTitleListener, int footHeigth) {
        mScrollThreshold = scrollThreshold;
        this.mShowTitleListener = showTitleListener;
        this.mFootHeight = footHeigth;
